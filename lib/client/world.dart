...
import 'package:mud/server.dart';
...
class World {
  ...
  World(http.Client client, {core.String rootUrl: "http://localhost:8080/", core
      .String servicePath: "world/v1/"}) :
  ...
  async.Future<Terrain> getWorldInfo(core.String x, core.String y) {
    ...
    _url = 'world/' + commons.Escaper.ecapeVariable('$x') + '/' +
        commons.Escaper.ecapeVariable('$y');
